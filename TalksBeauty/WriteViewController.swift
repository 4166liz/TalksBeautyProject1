...
class WriteViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        imaegView.contentMode = .scaleAspectFill
        imaegView.layer.masksToBounds = true
    ...
    @IBAction func submitClicked(_ sender: Any) {
        ...
        // Data in memory
        let data = UIImageJPEGRepresentation(imaegView.image!, 1.0)!
